...
class TestBasicFunctionality:
    ...
    def test_library_empty_creation(self, mock_load):
    ...
    @patch.object(Library, 'load_books')
    def test_library_add_book(self, mock_load):
    ...
    @patch.object(Library, 'load_books')
    def test_library_unique_isbn_validation(self, mock_load):
        """Test ISBN uniqueness validation"""
        library = Library([])
        book1 = Book("Book One", "Author One", "1234567890")
        book2 = Book("Book Two", "Author Two", "1234567890")  # Same ISBN
    ...
    @patch.object(Library, 'load_books')
    def test_library_find_books(self, mock_load):
